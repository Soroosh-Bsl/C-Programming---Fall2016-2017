...
void spaceUNK(void){
	...
	for(i = 0 ; i < 8 ; i++){
		sprintf(b, "RSSU %d.txt" ,i);
		file = fopen(b, "r");
		text2[i] = (char *)calloc (5000, sizeof(char));
		sprintf(c , "SpacedRSSUNK %d.txt" ,i);
		f = fopen(c , "w");
		while (fscanf(file, "%s", text2[i]) != EOF)
		{
			/* add spaces to seprate tags */
...
void replacehttpUNK(void){
	...
	for(i = 0 ; i < 8 ; i++){
		sprintf(b, "SpacedRSSUNK %d.txt" ,i);
		file = fopen(b, "r");
		text2[i] = (char *)calloc (5000, sizeof(char));
		sprintf(c , "httpsSpacedRSSUNK %d.txt" ,i);
		f = fopen(c , "w");
		while (fscanf(file, "%s", text2[i]) != EOF)
		{
			/* add spaces to seprate tags */
...
void replacehtmlsymbolsUNK(void){
	FILE *file , *f;
	int i , j;
	char b[30] , c[30];
	char temp[5000];
	...
	for(i = 0 ; i < 8 ; i++){
		sprintf(b, "httpsSpacedRSSUNK %d.txt" ,i);
		file = fopen(b, "r");
		text2[i] = (char *)calloc (5000, sizeof(char));
		sprintf(c , "replacesymbolshttpsSpacedRSSUNK %d.txt" ,i);
		f = fopen(c , "w");
		while (fscanf(file, "%s", text2[i]) != EOF)
		{
			/* add spaces to seprate tags */
...
void replacequUNK(void){
	...
	for(i = 0 ; i < 8 ; i++){
		sprintf(b, "replacesymbolshttpsSpacedRSSUNK %d.txt" ,i);
		file = fopen(b, "r");
		text2[i] = (char *)calloc (5000, sizeof(char));
		sprintf(c , "finalRSSUNK %d.txt" ,i);
		f = fopen(c , "w");
		while (fscanf(file, "%s", text2[i]) != EOF)
		{
			/* add spaces to seprate tags */
				...
				while( strcmp(text2[i] , "</item>") != 0  &&  fscanf(file, "%s", text2[i]) != EOF)
				{
					...
					if(strcmp(text2[i] , "<description>") == 0){
						...
						while( strcmp(text2[i] , "</description>") != 0){
							...
							if (strcmp(text2[i] , "</description>") == 0)
								break;
							if(flag == 0 && strcmp(text2[i], "[") != 0 && strcmp(text2[i], "]")!= 0 && strcmp(text2[i], "CDATA") != 0 && strcmp(text2[i], "<!")!= 0)
							{
