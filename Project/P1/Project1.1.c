...
void GET()
{
	...
	curl = curl_easy_init();
  	if(curl)
	{
   	 	curl_easy_setopt(curl, CURLOPT_URL, "http://fop-project.ir/news/get-urls");
...
{
	int nsent;
	char title[500], date[500], description[300], categorized[500], category[500], answer[2000], link[1000];
	CURL *curl;
  	CURLcode res;
